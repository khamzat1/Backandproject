...
router.post('/', async (req, res) => {
  ...
  //  const customer = mongoose.Types.ObjectId.isValid(req.body.customerId);
  //  const course = mongoose.Types.ObjectId.isValid(req.body.courseId);
  //mongoose typse orqali object idni alidatsiyta qilish kodini urqanub tugirlab ketish
